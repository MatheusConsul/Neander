...
public class Memoria{
  ...
  public void inserirDadosUser(boolean vetInstrucoesDados[], int posMemoria){

    Registrador8b reg = new Registrador8b();
    reg.executar(vetInstrucoesDados, true);
    memoria[posMemoria] = reg; 
